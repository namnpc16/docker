...
@section('content')
    ...
    <div class="card card-primary">
        ...
        <div class="alert alert-danger alert-dismissible">
            ...
            <p>{{ session()->get('thongbaoloi') }}</p>
        </div>
        @endif

        
        <a href="{{ route('cate.addview') }}" class="btn btn-outline-success"><i class="fas fa-plus-square"></i> Thêm mới</a>
        <a href="{{route('cate.listcate')}}" class="btn btn-outline-primary"><i class="fas fa-retweet"></i> Reload</a>
        <hr>
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <div class="card-body table-responsive p-0">
                    ...
                    <thead>
                        <tr class="bg-primary" >
                        <th><a  href="javascript:void(0)" class="header_column" data-id="id" style="color:white;">ID</th>
                        <th><a  href="javascript:void(0)" class="header_column" data-id="name" style="color:white;">Tên danh mục</th>
                        <th><a  href="javascript:void(0)" class="header_column" data-id="slug" style="color:white;">Slug name</th>
                        <th><a  href="javascript:void(0)" class="header_column" data-id="created_at" style="color:white;">Ngày Tạo</th>
                        <th>Thao tác</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="50%">
                                <a href="{{ route('cate.getidcate', ['id_edit' => $ct->id]) }}" class="btn btn-outline-warning"><i class="fas fa-edit"></i> Chi tiết</a>
                                <a href="" class="btn btn-outline-danger delcate" data-id="{{$ct->id}}"><i class="far fa-trash-alt"></i> Xóa</a>
                            </td>
                        </tr>
                        @endforeach
