        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-flat nav-compact" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview menu-open">
                    ...
                    <ul class="nav nav-treeview" style="display: block;">
                        <li class="nav-item">
                            <a href="{{route('cate.getlistcate')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Danh Mục Tin</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('addView.posts')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Thêm Tin Mới</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('getlistView.posts')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Danh Sách tin</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('tras.posts') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Bài Viết đã xóa</p>
                            </a>
                        </li>
