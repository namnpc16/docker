...
@section('title') Danh Sách Tin Đã Xóa @endsection
@section('content')
          ...
          @endif
            ...
            <div class="card card-default">
              ...
              <div class="card-header">
                <form id="frm_search" action="{{ route('trash.posts') }}" method="post">
                    <div class="row">
                ...
                <table class="table table-hover table-bordered text-nowrap">
                  <thead>
                    <tr class="bg-primary">
                      ...
                      <th width="14%"><a href="javascript:void(0)" class="header_column" data-id="deleted_at" style="color:white;">Ngày xóa</a></th>
                  ...
                  @foreach($postr as $p)
                    <tr>
                      <td width="5%">{{ $p->id }}</td>
                      <td width="27%"><p class="textstr">{{ Str::limit($p->title, $limit = 30, $end = '...')}}</p></td>
                      
                      <td width="20%"><img src="{{asset('/storage/posts') }}/{{$p->img}}" alt="" width="100%"></td>
                      <td width="14%">{{ $p->deleted_at }}</td>
                      <td width="20%">
                      ...
                      <td width="18%">
                        <a href="{{ route('restore.posts', ['id'=>$p->id]) }}" class="btn btn-outline-warning"><i class="fas fa-undo-alt"></i> Khôi phục lại</a>
                        <a href="" data-id="{{$p->id}}" class="btn btn-outline-danger delpost"><i class="far fa-trash-alt"></i> Xóa Vĩnh viễn</a> 
                      </td>
                    </tr>
                  @endforeach
              ...
              <!-- /.card-body -->
              <form id="form_delete" action="{{ route('forcedelete.posts') }}" method="post">
                @csrf
