            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-2 fix-col">
                        <div class="card">
                            <a href="{{ route('create.user') }}" class="btn btn-primary"><i class="fas fa-plus-circle"> Thêm mới !</i></a>
                        </div>
                    </div>
                    <div class="col-2 fix-col">
                      <div class="card">
                            ...
                            <div class="form-group fix-form-group">
                                <div class="card-tools">
                                  <div class="input-group input-group-sm" style="width: 250px;">
                                    <input value="{{ old('table_search') }}" id="search" type="text" name="table_search" class="form-control float-right" placeholder="Search">
...
@push('scripts')
    <script>
      $(document).ready(function () {
          ...
          //         let tableRow = ''
          //         let user = `<td><button class="btn btn-danger" style="width: 43.5px" ><i class="fas fa-user"></i></button></td>`;
          //         let admin = `<td><button class="btn btn-success" ><i class="fas fa-user-shield"></i></button></td>`;
          //         $('#table').html('')
          ...
          //                         <td> ${value.name} </td>
          //                         <td> ${value.email} </td>
          //                         <td><span class="tag tag-danger"> ${value.created_at} </span></td>

          //                         ${ (value.role == 1) ? admin : user}
          //                         <td class="fix-active-user">
          //                             <a href="{{ route('edit.user', ['id' => $item->id]) }}" class="btn btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i><i class="fas fa-user-edit"></i> Sửa</a>
          //                             <button class="btn btn-danger sbm-delete" name="sbm_delete" value="xóa" type="submit" data-value="${value.name}" data-id="${value.id}"><i class="fas fa-user-times"></i> Xóa</button>
          //                         </td>
          //                       </tr>`;
