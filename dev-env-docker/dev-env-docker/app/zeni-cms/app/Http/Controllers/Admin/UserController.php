...
class UserController extends Controller
{
    ...
    public function store(CreateUserRequest $request)
    {
        ...
        return redirect()->route('list.user')->with('success', __('user.controller.store', ['name' => 'thành viên']));
    }
    ...
    public function delete(Request $request)
    {
        ...
        return redirect()->route('list.user')->with('success', __('user.controller.softDelete', ['name' => 'Thành viên']));
    }
    ...
    public function restore(Request $request)
    {
        if ($request->restore_id) {
            ...
            return redirect()->route('soft.user')->with('success', __('user.controller.restore', ['name' => 'thành viên']));
            ...
            return redirect()->route('soft.user')->with('success', __('user.controller.delete', ['name' => 'thành viên']));
        }else{
            return false;
        }
    }
