...
class PageController extends Controller
{
    ...
    public function store(CreatePageRequest $request)
    {
        ...
        return redirect()->route('list.page')->with('success', __('user.controller.store', ['name' => 'page']));
    }
    ...
    public function update(EditPageRequest $request, $id)
    {
        ...
        return redirect()->route('list.page')->with('success', __('user.controller.update', ['name' => 'page']));
    }
    ...
    public function delete(Request $request)
    {
        ...
        return redirect()->route('list.page')->with('success', __('user.controller.delete', ['name' => 'page']));
    }
}
